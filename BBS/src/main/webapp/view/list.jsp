...
<script type="text/javascript">
	function write_go() {
		location.href="/BBS/MyController?cmd=write";
	}
				...
				<tr>
					<td colspan="4">
						...
						<!-- 이전 -->
						    ...
						    <!-- 블록안에 들어간 페이지번호들 -->
						    <c:forEach begin="${pagig.beginBlock }" end="${paging.endBlock }" step="1"  var="k">
						    	<!-- 현재페이지와 현재페이지가 아닌 것을 나누자 -->
						    	<!-- 돌면서 현재 페이지냐 아니냐 묻는다 -->
						    	<c:choose>
